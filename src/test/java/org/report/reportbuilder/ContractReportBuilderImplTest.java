...
class ContractReportBuilderImplTest {
    ...
    void buildReport() {
        ...
        ReportBuilder builder= new ContractReportBuilderImpl();
        ...
        verify(printer, times(1)).printUniqueCustomerCount("contractId", expectedOutput);
